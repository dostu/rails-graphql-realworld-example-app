...
Schema implements [Relay Connections specification](https://facebook.github.io/relay/graphql/connections.htm). This allows it to be used with different graphql clients: Relay, Apollo, etc.
